...
# The most important is also the easiest to miss
...
knowledge2 = And(
    ...
    Implication(BKnave, Not(Or(And(AKnave, BKnight), And(AKnave, BKnight))))
    # TODO
)
...
knowledge3 = And(
    ...
    Implication(BKnave, Implication(AKnave, BKnave)),
